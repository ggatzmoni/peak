...
def main():
    ...
    filtered_results = df_kaggle[df_kaggle['genres'].str.contains(query_genre) & (df_kaggle['year'].str.contains(query_decade[0:3])) & (df_kaggle['popularity_binned'] == query_pop)] # [0:3] for 1920s / [1:3] for (1920 -1930]
    ...
    #Training the model
    features_names = ['scaled_tempo', 'danceability', 'energy'] # 'scaled_loudness' , 'valence' , 'scaled_key'
    ...
    knn_out, k = [], 100
    knn_out = model.kneighbors([[tempo,da,energy]], n_neighbors=k) # loudness, ,valence ,key
